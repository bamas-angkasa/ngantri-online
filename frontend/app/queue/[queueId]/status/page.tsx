    ...
    <main className="grid min-h-screen place-items-center bg-[#F9FAFB] px-4 py-10">
      <Card className="w-full max-w-md rounded-[28px] border-slate-100 bg-white shadow-xl shadow-slate-900/5">
        <CardContent className="p-6 text-center">
          ...
          <p className="mt-5 text-sm font-black uppercase text-slate-500">Status antrean</p>
          <h1 className="mt-2 text-5xl font-black">A-16</h1>
          <p className="mt-3 font-semibold text-slate-500">ID: {queueId}</p>
          <div className="mt-6 rounded-2xl bg-emerald-50 p-4 font-black text-emerald-700">3 antrean lagi, silakan bersiap.</div>
        </CardContent>
      </Card>
    </main>
  );
